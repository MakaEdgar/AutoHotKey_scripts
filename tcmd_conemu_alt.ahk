...
;
; Press Alt-Space to switch between Tcmd and ConEmu (the path is
...
;   (double click on it). Open Total Commander and press Alt-Space to
;   focus on ConEmu; inside it pressing Alt-Space again switching back to
;   Tcmd.
;
